...
const AddCar = () => {
  ...
  return (
    <div className='px-4 py-10 md:px-10 flex-1'>
      <Title title="Add New Car" subTitle="Fill in details to list a 
      new car for booking,including pricing,availability, and car specification" />
      ...
      text-gray-500 text-sm mt-6 max-w-xl'  >
        ...
        <div className='grid grid-cols-1 md:grid-cols-2 gap-6'>
          <div className='flex flex-col w-full'>
            <label>Brand</label>
            <input type="text" placeholder="e.g. BMW, Merceded, Audi..." required className='px-3 py-2 mt-1
        ...
        <div className='grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6'>
          ...
          <div className='flex flex-col w-full'>
            ...
            <input type="number" placeholder="4" required className='px-3 py-2  mt-1 
            border border-borderColor rounded-md outline-none'
        ...
        <div className='flex flex-col w-full'>
          ...
          <textarea rows={5} type="number" placeholder="e.g. Aluxurious SUV with a spacious interior and a powerfull engine."
        ...
        <button className='flex items-center gap-2 px-4 py-2.5 mt-4
         bg-primary text-white rounded-md font-medium w-max cursor-pointer'>
          <img src={assets.tick_icon} alt="" className='w-4 h-4'></img>
