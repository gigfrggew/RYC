  ...
  return (
    <motion.div
      ...
      <motion.form
        ...
        justify-between p-6 rounded-lg md:rounded-full  w-full max-w-md md:max-w-3xl
        ...
        <motion.button
          ...
          whileTap={{ scale: 0.95 }}
          className='flex items-center justify-center gap-1 px-5 py-2 max-sm:mt-4
           bg-primary hover:bg-primary-dull text-white rounded-full cursor-pointer'>
          <img src={assets.search_icon1} alt="search" className='w-4 h-4 brightness-300' />
          Search
        </motion.button>
      ...
      <motion.img
        ...
        src={assets.main_car2} alt="car" className="w-150 h-auto" />
    </motion.div>
  )
}
