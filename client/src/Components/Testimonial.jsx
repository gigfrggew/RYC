...
const Star = ({ filled }) => (
    ...
    >
        <path
            ...
            d="M12 17.25l-6.16 3.73 1.64-7.03L2.5 9.77l7.19-.61L12 2.5l2.31 6.66 7.19.61-4.98 4.18 1.64 7.03L12 17.25z"
        />
    </svg>
)
...
const Testimonial = () => {
    ...
    const testimonials = [
        ...
        {
            name: "Ava Jhonson",
            location: "Sydney Austrailiak",
            image: assets.testimonial_image3,
    ...
    return (
      ...
      choose StayVenture for their luxury accomodation around the world" />

            <div
                className="grid grid-cols-1 dm:grid-cols-2 lg:grid-cols-3 gap-8 mt-18">
