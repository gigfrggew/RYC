  ...
  return (
    <motion.div
     ...
     ${location.pathname === "/" && "bg-light"}`}>
      ...
      <Link to='/' >
        <motion.img whileHover={{ scale: 1.10 }} transition={{ duration: 0.4, ease: "easeOut" }} src={assets.logo1} alt="logo" className="h-20 " />
      </Link>
      ...
      <div className={`max-sm:fixed max-sm:h-screen max-sm:w-full max-sm:top-16 max-sm:border-t
         ...
         gap-4 sm:gap-8 max-sm:p-4 transition-all duration-300 z-50 ${location.pathname === "/" ? "bg-light" : "bg-white"} 
      ...
      {/*For smaller screens like smartphone*/}
